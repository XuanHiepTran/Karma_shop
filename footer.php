<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="ft col-xs-12 col-sm-12 col-md-3 col-lg-3">
				...
				<div class="contact">			
					...
					<p><i class="fa fa-map-marker"></i>70 Tô Ký, Phường Tân Chánh Hiệp, Quận 12, TPHCM</p>
	              	<p><i class="fa fa-envelope"></i>KarmaShop@gmail.com</p>
	                <p><i class="fa fa-phone"></i>0987.987.987</p>
				</div>	
			</div>
			<div class="ft col-xs-12 col-sm-12 col-md-3 col-lg-3">
				<p class="titleft">CONNECT</p>
				<ul class="connect">
					<li><a href="https://www.facebook.com/KarMaShopOficial"><i class="fa fa-facebook"></i></a></li>
...
<div id="cfacebook">
    ...
    <div id="fchat" class="fchat">
        <div class="fb-page" data-tabs="messages" data-href="https://www.facebook.com/KarMaShopOficial" data-width="250" data-height="400" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"></div>
        <div class="chat-single"><a target="_blank" href="https://www.facebook.com/KarMaShopOficial"><i class="fa fa-facebook-square"></i> KarmaShop </a></div>
    </div>
