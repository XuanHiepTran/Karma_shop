...
<?php
	...
	switch($menu){
		...
		case 'view_user': include('chuc_nang/user/view_user.php'); break;
		case 'add_user': include('chuc_nang/user/add_user.php'); break;
		case 'edit_user': include('chuc_nang/user/edit_user.php'); break;
		case 'delete_user': include('chuc_nang/user/delete_user.php'); break;
	}
}
else{
